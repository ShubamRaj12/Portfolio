...
Portfolio is one file, `index.html`. It's plain text underneath — no special software required to edit it, and no build step. Change the text, save, refresh the
browser, done.
